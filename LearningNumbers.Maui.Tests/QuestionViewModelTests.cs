...
namespace LearningNumbers.Tests
{
    ...
    public class QuestionViewModelTests
    {
        ...
        [Test]
        public void OnAppearing_ValidConfiguration_NoThrowException()
        {
            Assert.DoesNotThrow(() => _systemUnderTest.OnAppearing(new QuestionConfiguration()));
        }

        [Test]
        public void OnAppearing_ValidConfiguration_NumberOfQuestionsIsCorrect()
        {
            _systemUnderTest.OnAppearing(new QuestionConfiguration {QuestionsNumber = 10});

            Assert.AreEqual(10, _systemUnderTest.NumberOfQuestions);
        }

        [Test]
        public void OnAppearing_ValidConfiguration_IsAppliedCorrectly([Values(true, false)] bool canSum,
            ...
            [Values(true, false)] bool canDivide)
        {
            ...
            _systemUnderTest.OnAppearing(new QuestionConfiguration
            {
        ...
        [Test]
        public void OnAppearing_Configured10QuestionsNotAnsweredToAnyQuestion_ShowEndIsFalse()
        {
        ...
        [Test]
        public void OnAppearing_Configured10QuestionsNotAnsweredToAnyQuestion_CurrentAttemptsAreThree()
        {
            _calculationGeneratorMock.SetupSum(10, 20);
        ...
        [Test]
        public void OnAppearing_Configured10QuestionsNotAnsweredToAnyQuestion_WrongAnswerAreZero()
        {
            _calculationGeneratorMock.SetupSum(10, 20);
        ...
        [Test]
        public void OnAppearing_Configured10QuestionsNotAnsweredToAnyQuestion_CorrectAnswerAreZero()
        {
            _calculationGeneratorMock.SetupSum(10, 20);
        ...
        {
            _systemUnderTest.OnAppearing(new QuestionConfiguration {QuestionsNumber = questions});
