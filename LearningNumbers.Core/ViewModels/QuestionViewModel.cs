...
using LearningNumber.Core.Exceptions;
...
namespace LearningNumber.Core.ViewModels
{
    public class QuestionViewModel : BaseViewModel
    {
            ...
            base(navigation)
        {
            ...
            CheckAnswerCommand = new RelayCommand(ExecuteCheckCommand);
            WriteNumberCommand = new RelayCommand<string>(ExecuteWriteNumberCommand);
            RemoveLastCharInAnswer = new RelayCommand(ExecuteRemoveLastCharInAnswer);
        }

        public void OnAppearing(QuestionConfiguration configuration)
        {
